...
import { Star, StarHalf, Shield, Truck, RotateCcw, Check, ChevronRight, Heart } from "lucide-react"
            ...
            >
              {product.badge && (
                <div className="absolute top-4 right-4 z-10">
                  <Badge variant="new" className="font-medium">
                    {product.badge}
                  </Badge>
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                <Button className="flex-1 bg-accent-500 hover:bg-accent-600 text-white" onClick={handleAddToCart}>
                  Add to Cart
                </Button>
                <Button
                  variant="outline"
